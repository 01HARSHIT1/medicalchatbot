...
#     pre = precautions[precautions['Disease'] == dis].iloc[:, 1:5].values.tolist()[0]
...
# symptoms_dict = {...}  # Keep as is
# diseases_list = {...}  # Keep as is
...
# def developer():
#     return jsonify({"message": "Developer page content"})

# @app.route("/blog", methods=["GET"])
# def blog():
#     return jsonify({"message": "Blog page content"})
...
def check_disease():
    ...
    try:
        # Get all symptoms for the given disease
        disease_symptoms = sym_des[sym_des['Disease'] == disease_name]
